...
/**
 * Left-pane "Chromatik-MCP" section: connection indicator, server URL, and time of last client
 * activity. Sized to match the stock global sections (UICamera, UIAudio).
 */
class UIChromatikMcpSection extends UICollapsibleSection {
  ...
  UIChromatikMcpSection(LXStudio.UI ui, ServerStatus status) {
