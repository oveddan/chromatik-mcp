...
public final class MoveEffect implements LxTool {
  ...
  public Result<Map<String, Object>> handle(LX lx, Map<String, Object> args) {
    ...
    if (containerPath == null) {
      ...
      describe(payload, result.effect());
      payload.put("oscChanges", OscChanges.payload(result.oscChanges()));
      payload.put("droppedWiring", Wiring.payload(List.of()));
    } else {
      Channels.EffectRelocateResult result =
          Channels.relocateEffect(lx, path, containerPath, index);
      describe(payload, result.effect());
      payload.put("oscChanges", OscChanges.payload(result.oscChanges()));
  ...
  private static void describe(Map<String, Object> payload, LXEffect effect) {
