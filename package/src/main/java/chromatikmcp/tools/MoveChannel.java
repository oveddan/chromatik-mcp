...
public final class MoveChannel implements LxTool {
  ...
  public String description() {
    return "Move a channel or group to a 0-based destination index in the mixer's flat "
        ...
        + "for the moved block, crossed siblings, their effects/patterns, bus-level modulation, "
        + "grid clips and lanes, and corresponding arrange-timeline lanes — re-list rather than "
