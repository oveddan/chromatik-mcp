...
/**
 * Writes {@code ~/.chromatik-mcp/status.json} so MCP clients can discover the running
...
public final class StatusFile {
  ...
  /** The {@code ~/.chromatik-mcp/status.json} path (does not require the file to exist). */
  public static Path path() {
    return Paths.get(System.getProperty("user.home"), ".chromatik-mcp", "status.json");
  }
