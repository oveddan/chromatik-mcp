...
- Every domain primitive gets a JUnit test against a headless LX instance (follow existing patterns in package/src/test/java/lxmcp/domain/); tool handlers get HTTP integration coverage in ToolsIntegrationTest, including the tool-registry name set.
