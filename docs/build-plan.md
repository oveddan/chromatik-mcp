...
- [ ] **PR-7b** — `get_component_doc` MCP tool + `domain/Catalog.java` (three-tier lookup, flat-frontmatter parse, bytecode-hash staleness), `documented` flag in `list_available_*`, `CatalogFormatTest` gate —
