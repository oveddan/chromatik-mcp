...
- [~] **Undo/redo command history** — issue [#198](https://github.com/oveddan/chromatik-mcp/issues/198), ready for review in [#199](https://github.com/oveddan/chromatik-mcp/pull/199); one-step shared linear history with affected-command and next-history reporting, explicit empty no-ops, verified failure/stack-clear diagnostics, and top-level-only batch safety
