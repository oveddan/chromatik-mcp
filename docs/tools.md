...
| `radius` | number | no | — | Distance from the eye to the target, in model units. Also sets the framing in orthographic projection, where the visible width is radius. |
